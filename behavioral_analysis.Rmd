...
ggplot(cleandata_agg_pred, aes(x = condition, y = Accuracy, color = condition)) +
  ...
  geom_line(aes(group = participant), size = 0.2, color = "lightgrey") +  # Neutral line color
  ...
  theme(
    ...
    legend.background = element_rect(fill = "white", size = 0.2, linetype = "solid", colour = "lightgrey"),
    text = element_text(size = 12, family = "sans"),  # Adjusted font size
    plot.title = element_text(hjust = 0.5, size = 16, face = "bold", family = "sans"),  # Adjusted title aesthetics
